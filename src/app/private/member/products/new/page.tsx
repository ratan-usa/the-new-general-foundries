...
export default function NewProductPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] pb-20">
      ...
      {/* === TOP BAR === */}
      <div className="bg-white border-b border-[#000000] sticky top-0 z-30 px-6 py-4 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <Link href="/private/member/products" className="px-4 py-2 text-sm font-medium text-[#D80621] bg-white border border-[#000000] rounded-lg hover:bg-[#ffffff]">
            Cancel
          </Link>
          <button
        ...
        <form className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-[#000000] rounded-lg focus:ring-2 focus:ring-[#D80621] outline-none"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      className="w-full px-4 py-2 bg-[#ffffff] border border-[#000000] rounded-lg text-[#D80621] cursor-not-allowed"
                    />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-[#000000] rounded-lg bg-white"
                  >
            ...
            <section className="bg-white p-6 rounded-xl shadow-sm border border-[#000000]">
              ...
              <div className="border-2 border-dashed border-[#000000] rounded-xl p-8 text-center bg-[#ffffff]">
          ...
          <div className="space-y-6">
            ...
            <section className="bg-white p-6 rounded-xl shadow-sm border border-[#000000]">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-2 border-b border-[#000000]">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    className="w-full mt-1 px-3 py-1.5 border border-[#000000] rounded text-sm"
                  />
                </div>
                <div>
