  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-10 py-3">
      ...
      <div className="hidden lg:block relative h-[500px] w-full max-w-6xl mx-auto">
        ...
        {/* Start/End Caps */}
        <div className="absolute left-[-20px] bottom-[80px] w-10 h-10 bg-[#ffffff] rounded-full border-4 border-white"></div>
        <div className="absolute right-[-20px] bottom-[80px] w-10 h-10 bg-[#ffffff] rounded-full border-4 border-white"></div>
