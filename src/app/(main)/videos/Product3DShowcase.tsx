...
export default function Product3DShowcase() {
  ...
  return (
    <section className="bg-[#ffffff] text-[#D80621] py-20 border-t border-[#000000] w-full">
      <div className="w-full px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
          ...
          <div className="lg:col-span-2 w-full">
            <div className="relative aspect-video -[#D80621] rounded-none border border-[#000000] shadow-2xl overflow-hidden group">
              ...
              <div className="absolute top-4 left-4 z-20 flex items-center gap-2 bg-[#D80621]/80 backdrop-blur-sm border border-[#000000] px-3 py-1.5">
            ...
            <div className="mt-4 p-6 bg-[#ffffff] border border-[#000000] rounded-none space-y-2">
          ...
          <div className="lg:col-span-1 bg-[#ffffff] rounded-none border border-[#000000] p-4 h-full flex flex-col justify-between min-h-[400px]">
            <div className="w-full">
              <h4 className="text-[#D80621] font-bold uppercase text-xs tracking-widest mb-4 flex items-center gap-2 border-b border-[#000000] pb-3">
                    ...
                    <div 
                      ...
                      className={cn(
                        ...
                        isCurrent 
                          ...
                          : "-[#D80621] border-[#000000] hover:border-[#000000]"
                      )}
                    >
                      {/* Thumbnail Placeholder Window */}
                      <div className="relative w-24 h-16 bg-[#ffffff] rounded-none overflow-hidden shrink-0 flex items-center justify-center border border-[#000000]">
                        <Image 
                          src={video.thumbnail} 
                          alt="thumb" 
                          fill 
            ...
            <div className="mt-6 pt-4 border-t border-[#000000] text-left w-full">
               <Button variant="outline" className="w-full text-xs text-white bg-transparent border-[#000000] hover:bg-white hover:-[#D80621] font-black uppercase tracking-wider h-11 rounded-none transition-colors">
