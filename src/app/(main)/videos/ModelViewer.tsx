  ...
  return (
    <div className="w-full h-full bg-gray-100 rounded-lg overflow-hidden relative group">
      ...
      */}
      ...
      <div className="absolute bottom-4 left-4 bg-black/80 text-white text-xs font-bold px-3 py-1.5 rounded-full pointer-events-none backdrop-blur-md">
        Interactive 3D View
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-100 group-hover:opacity-0 transition-opacity duration-500">
         <div className="bg-black/20 px-4 py-2 rounded-lg text-white text-sm font-medium backdrop-blur-sm">
