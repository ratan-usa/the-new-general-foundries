              ...
              >
                ...
                <div className="relative aspect-square w-full rounded-lg overflow-hidden border border-[#cccccc] -[#D80621] mb-3 shadow-sm hover:shadow-md transition-all">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="w-10 h-10 -[#D80621]/40 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/20 group-hover:bg-[#D80621] group-hover:border-[#D80621] transition-colors">
                      <Maximize2 className="w-5 h-5 text-white" />
                    </div>
                  </div>
                </div>

                <h3 className="text-sm font-bold text-[#D80621] leading-snug group-hover:text-[#D80621] transition-colors line-clamp-2">
                  {video.title}
                </h3>
              </div>
            ))}
