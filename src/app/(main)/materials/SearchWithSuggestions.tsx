...
const searchData = [
  ...
  { title: "Team Canada Login Portal", category: "Login > Team", href: "/login/team" },
            ...
            <div className="divide-y divide-gray-50">
              {filteredItems.map((item, index) => (
                <Link 
                  ...
                  className="block px-4 py-3 hover:bg-[#ffffff] transition-colors border-l-4 border-transparent hover:border-[#D80621]"
                >
