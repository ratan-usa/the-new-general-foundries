...
const MANIFEST_STEPS: ManifestPhase[] = [
  {
    icon: <Cpu className="w-5 h-5 text-[#D80621]" />,
  ...
  {
    icon: <Flame className="w-5 h-5 text-[#D80621]" />,
  ...
  {
    icon: <Zap className="w-5 h-5 text-[#D80621]" />,
  ...
  {
    icon: <ShieldCheck className="w-5 h-5 text-[#D80621]" />,
        ...
        <div className="border-b border-zinc-900 pb-12 mb-20 flex flex-col xl:flex-row xl:items-end justify-between gap-8">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl sm:text-6xl md:text-7xl font-black uppercase tracking-tighter leading-none">
              NOT ONE STEP BUT <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D80621] to-white">
