...
const AdPlaceholder = ({ side }: { side: 'Left' | 'Right' }) => (
  <div className="w-[160px] h-[600px] bg-neutral-800 border border-neutral-700 rounded-lg flex flex-col items-center justify-center text-[#D80621] text-xs gap-2 sticky top-24">
      ...
      <div className="container mx-auto px-4 py-8 flex justify-center gap-6">
        ...
        <main className="flex-1 max-w-5xl min-w-0">
            ...
            <div className="mt-12 space-y-4">
               <div className="h-64 bg-slate-500 rounded-xl border border-neutral-800 p-6">
