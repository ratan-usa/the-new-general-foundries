...
// Data modeled after your "Canada Foundries" capabilities
const tagLines = [
  {
    id: 1,
  ...
  },
  {
    ...
    description: "Positions Canada Foundries as a dominant and reliable global leader. This tagline reflects our strong industrial capabilities, consistent product performance, and our established reputation in global markets as a trustworthy and powerful industrial partner.",
    imgUrl: "/assets/image3.jpeg"
  },
  {
    id: 4,
    lines: "Learning Never Ends. Excellence Never Stops.",
    description: "Represents Canada Foundries’ internal culture of continuous learning, modern training, R&D enhancement, skill development, and dedication to industry-leading standards. Excellence is a process, not a destination.",
    imgUrl: "/assets/image4.jpg"
  },
  {
    id: 5,
    lines: "Always Delivering Beyond Expectations.",
    description: "Emphasizes Canada Foundries’ reputation for exceeding industry standards and client expectations. The company consistently delivers superior quality, innovative solutions, and high-performance engineering across all product lines.",
  ...
  },
  {
    ...
    description: "Reflects the limitless technological, engineering, and industrial capabilities of Canada Foundries. Whether scaling production or innovating with new materials, the potential for growth is endless.",
    imgUrl: "/assets/image8.jpeg"
  },
  {
    id: 9,
    lines: "Your Vision. Our Undertaking.",
    description: "Shows a client-centered approach where Canada Foundries converts customer concepts into real, functioning industrial solutions. This tagline reflects commitment, precision execution, and a long-term partnership mindset.",
    imgUrl: "/assets/image9.jpeg"
  },
  {
    id: 10,
    lines: "Comforting the Future.",
    description: "Symbolizes the long-term sustainability, safety, and reliability built into Canada Foundries’ engineering processes and product designs—ensuring the future is strong, stable, and secure.",
  ...
  },
  {
    ...
    description: "Encourages industries to upgrade from outdated machinery and legacy systems to advanced, efficient, and future-ready solutions created by Canada Foundries.",
    imgUrl: "/assets/image12.jpg"
  },
  {
    id: 13,
    lines: "Non-Stop Innovations. Non-Stop Progress.",
    description: "Highlights Canada Foundries’ continuous investment in R&D, new materials, enhanced engineering methods, and innovative industrial solutions that advance global manufacturing standards.",
    imgUrl: "/assets/image13.jpg"
  },
  {
    id: 14,
    lines: "Always Ahead of the Industry.",
    description: "Positions Canada Foundries as an industry leader in innovation, global expansion, and next-generation engineering. This tagline reflects a future-focused mindset and competitive advantage.",
    imgUrl: "/assets/image14.jpeg"
  },
  {
    id: 15,
    lines: "Our Investment Today, Your Reward Tomorrow.",
    description: "Shows Canada Foundries’ long-term value approach. Every product is engineered to deliver consistent, high-performance results for years or decades—ensuring customers benefit long after installation.",
    imgUrl: "/assets/image15.jpeg"
  },
  {
    id: 16,
    lines: "Price is Right. Commitments Are Everlasting.",
    description: "Reflects transparent pricing, ethical business practices, and commitment to long-term partnerships. Canada Foundries values trust and delivers continuous support throughout the customer lifecycle.",
    imgUrl: "/assets/image16.jpg"
  },
  {
    id: 17,
    lines: "Mother Earth to Your Dock.",
    description: "Perfect for sourcing and logistics sections. It represents Canada Foundries’ global supply chain strength, where raw materials and products move reliably from international sources directly to client facilities.",
  ...
  },
  {
    ...
    description: "Reflects global scalability. Canada Foundries designs and manufactures industrial solutions capable of serving international sectors without limitations on geography, complexity, or scale.",
