...
export default function BackgroundMusic() {
  ...
  return (
    <div className="fixed bottom-72 right-6 z-50">
      ...
      <button
        onClick={toggleAudio}
        className=" flex items-center justify-center w-12 h-12 bg-[#D80621] text-white rounded-full shadow-lg border-2 border-white hover:bg-red-700 hover:scale-110 transition-all duration-300 animate-fade-in "
      >
        {isPlaying ? (
