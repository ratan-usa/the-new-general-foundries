    ...
    return (
        <div className="border-t border-[#cccccc] bg-[#ffffff]">
            ...
            <div className="w-full px-2 sm:px-6 lg:px-10 flex flex-row items-center justify-between gap-2 md:gap-4">
                ...
                <div className="flex-1 overflow-x-auto md:pb-0 [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-thumb]:bg-[#ffffff] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent no-scrollbar">
