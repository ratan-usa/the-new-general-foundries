  ...
  return (
    <div className="fixed bottom-20 right-24 z-50">
      <Link 
        href="#get-quote"
        onClick={handleClick}
        className="group flex items-center gap-3 bg-[#D80621] text-white px-6 py-4 rounded-full shadow-[0_4px_14px_0_rgba(204,34,33,0.39)] hover:shadow-[0_6px_20px_rgba(204,34,33,0.23)] hover:bg-red-700 transition-all duration-300 transform hover:-translate-y-1"
      >
